...
.. image:: ../../img/gridtools/Sample-Roughness-Data/img3.png
...
.. image:: ../../img/gridtools/Sample-Roughness-Data/img2.png
...
.. image:: ../../img/gridtools/Sample-Roughness-Data/img4.png

Centroid Point Sample
----------------------

1. To calculate a point sample from the centroid
   of the grid element on the manning’s polygons, use the Source Layer and Intersect cell centroid option.

.. image:: ../../img/gridtools/Sample-Roughness-Data/img5.png

Roughness Update
----------------

2. This option will only update cells whose centroid lies within the Roughness Layer polygons and leave all other values as is.

.. image:: ../../img/gridtools/Sample-Roughness-Data/img6.png

3. Once the sample is complete, the following window will appear.
   Click OK to close the window.

.. image:: ../../img/gridtools/Sample-Roughness-Data/img7.png

The roughness values are assigned to the Grid layer in the Schematized Layers group.

.. image:: ../../img/gridtools/Sample-Roughness-Data/img8.png

4. If it is necessary to update or change a
   small selection of elements, use the Roughness layer in the User Layers group.

.. image:: ../../img/gridtools/Sample-Roughness-Data/img9.png
...
5. This processor uses a moving window and processes data in blocks.  If the process fails, rasterize the data and use
   the Grid Roughness from Raster method.
