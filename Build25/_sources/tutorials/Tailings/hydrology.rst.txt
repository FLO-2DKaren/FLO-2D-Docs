...
5. The rainfall data is imported into the FLO-2D Table Editor.
   For better visualization of the plot, click **Auto Range** button.
...
.. image:: ../img/Tailings/tdhydro/tdhydro033.png

Step 5: Export and run the model
--------------------------------

1. Click the main Save icon on the QGIS toolbar, and click **OK** when prompted to save
   external layers.

.. image:: ../img/Tailings/tdhydro/tdhydro015.png

2. In the next window, move Elevation Pre Disaster, Aerial-Pre Disaster, and Landuse TD
   layers to the left (Geopackage Layers) and click **OK**.

.. image:: ../img/Tailings/tdhydro/tdhydro028.png

3. Click the FLO-2D Data Export icon.

.. image:: ../img/Tailings/tdhydro/tdhydro016.png

4. Review the image and Click OK

.. image:: ../img/Tailings/tdhydro/tdhydro017.png

5. Create a folder named Export Hydrology and export the project. Once
   the project is exported click OK to close the export message.

.. image:: ../img/Tailings/tdhydro/tdhydro018.png

6. Before running FLO-2D for the first time, the Run Settings must be
...
7. The Run Settings is used to configure the FLO-2D executable path and
...
8. Click on the Run FLO-2D icon to run the simulation.

.. image:: ../img/Tailings/tdhydro/tdhydro022.png

9. The model runs in Text Mode. When it is finished, check the
...
3. Right-click the Final Depth Hydrology layer (or alternatively,
   double-click it) and open its properties menu.

.. image:: ../img/Tailings/tdhydro/tdhydro030.png

4. Set Min value as 0.1 and check the Clip out of range values then click **OK**.

.. image:: ../img/Tailings/tdhydro/tdhydro031.png
...
5. The Final Depth Hydrology layer should now look as shown below.

.. image:: ../img/Tailings/tdhydro/tdhydro032.png