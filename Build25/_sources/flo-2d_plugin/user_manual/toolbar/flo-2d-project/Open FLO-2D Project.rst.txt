...
1. If the GeoPackage is outdated, FLO-2D Plugin will ask the user to update it.

.. image:: ../../img/Flo-2D-Project/openflo2dproject003.png

2. Click Yes to update or No to cancel.

3. The project with the updated GeoPackage will be loaded.
